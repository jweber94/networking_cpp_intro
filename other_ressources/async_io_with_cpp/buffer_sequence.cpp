...
int main() {
    ...
    std::array<io::const_buffer, 3> buffer_sequence_view{header_buffer_view, payload_buffer_view, payload_buffer_view_2}; 
...
/*
* Compile Command: 
*   $ g++ buffer_sequence.cpp -pthread --std=c++17 -I/usr/local/include -L/usr/local/lib -lboost_coroutine -lboost_context -lboost_system
*
